...
/**
 * Implementation of the Tiny Encryption Algorithm (reeklama.TEA).
...
public class TEA {
    ...
    //Инициализировуем шифр для шифрования или дешифрования
    public TEA(byte[] key) {
        if (key == null)
    ...
    /*
        шифруем
        clear - текст для шифрования
        возвращаем зашифрованный текст

        создаем блок, который далее шифруем в brew
    */
